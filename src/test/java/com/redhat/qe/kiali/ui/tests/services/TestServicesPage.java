...
@Slf4j
public class TestServicesPage extends TestAbstract {
    ...
    private void checkNumberOfItems(Integer perPage) {
        ...
        List<Service> serviceList = page.list().items();
    ...
    public void loadThisPage() {
        page = new ServicesPage(webDriver());
        rootPage = page;
    }
    ...
    public void testFilterFeature() {
        ...
        List<Service> serviceItems = page.list().items();
